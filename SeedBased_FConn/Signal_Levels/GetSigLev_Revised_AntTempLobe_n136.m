...
subs = ReadList('/oak/stanford/groups/menon/projects/daa/2015_ACx_parcellation_HCP/data/subjectlist/Replicat_Sample_n136/QC_Behav_and_Movement_Eligible_Subs_S1200_n136.txt');
...
for sub_i = 1:length(subs)
    ...
    for roi_i = 1:length(roi_names)
        ...
        hcp_fname = fullfile(root_dir, subs{sub_i}, 'visit1/session3/seedfc/resting_state_1/stats_spm8',...
...
save_fname = fullfile(results_dir, 'MonsterMatrix_HCP_LH_AntTempLobe_n136_Mean_STE.mat');
